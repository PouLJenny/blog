...
风险投资判断一个项目的时候就是判断项目的赔率和概率！

哪些人重走了宋江的路？？

最容易犯的错误：
- 全局： 市场分析不足、市场分析泛泛、缺乏客观数据
- 问题： 需求/痛点缺少普适性、真实性、合理性
- 答案： 答非所问，循环论证、方案无效
- 实施： 不清晰、缺少实战思维、纸上谈兵
- 结果： 过分乐观，缺少风险意识、不理解资本的规则
...
BP中的隐藏信息
1. 没有故事线、或故事线不健全   -》 需求禁不起推敲，拿着锤子找钉子、FA不专业
2. 字数太多、面面俱到、信息庞杂 -》  战略思考能力差，分不清主次、不理解自己所做的事情、拼凑。不要用战术上的勤奋来弥补战略上的不足
3. 该写的没写                -》  不懂、不重视、短板
4. 过分强调的内容             -》 用不可能三角去挖掘背面信息 类似于CAP理论，三角不能同时满足
5. 细节处理不够              -》  警惕职业度问题
...
当投资人问你一个很有压力、棘手的问题时？不要应急，要告诉他你思考过这个问题。
...
创业从第一天开始就要考虑生存问题，考虑自己造血的问题，财务是否足够健康。
